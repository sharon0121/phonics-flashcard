...
import {
  useAngryCowWordSources,
  setAngryCowWordSources,
  WORD_SOURCE_LABELS,
  ...
  type AngryCowMaxValue,
  useAngryCowSpeechRate,
  setAngryCowSpeechRate,
  type SpeechRate,
    ...
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8">
      ...
      <div className="mt-6 rounded-xl border-2 border-[var(--hero-gold)] bg-white/95 p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-bold text-zinc-900">📚 英文版題目來源</h2>
          <button
            type="button"
      ...
      <div className="mt-4 rounded-xl border-2 border-[var(--hero-gold)] bg-white/95 p-4">
        ...
        <p className="mt-2 text-xs text-zinc-500">加減算式中每個數字最大不超過這個範圍。</p>
      </div>
      ...
      <div className="mt-4 rounded-xl border-2 border-[var(--hero-gold)] bg-white/95 p-4">
        ...
        <p className="mt-2 text-xs text-zinc-500">英文版牌子上喇叭按鈕朗讀中文的速度。</p>
      </div>
    </main>
  );
}
