...
const games: GameEntry[] = [
  ...
  },
  {
    ...
    title: '俄羅斯方塊',
    titleEn: 'Tetris',
    description: '完整 Tetris Guideline：7-Bag 隨機、SRS 旋轉踢牆、T-Spin 判定、B2B 連擊、Ghost Piece',
    ready: true,
  },
  {
    href: '/games/puyo',
    ...
    title: '魔法氣泡',
    titleEn: 'Puyo Puyo',
    description: '顏色相連 4 個就消除！越高連鎖攻擊力越強，全消有大獎勵！',
    ready: true,
  },
  {
    ...
    emoji: '🧱',
    title: '積木消除',
    titleEn: 'Block Puzzle',
    description: '拖曳積木填滿整行整列就消除！集滿貓爪印記過關，連續消除還有連擊加成！',
    ready: true,
  },
  {
    ...
    emoji: '🏎️',
    title: '邏輯數列太空賽車',
    titleEn: 'Logic Sequence Space Racer',
    description: '選車道、按衝刺！看數列規律撞向答案，關卡自動升級，幫助背九九乘法表',
    ready: true,
  },
