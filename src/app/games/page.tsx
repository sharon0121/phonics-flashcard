...
const games: GameEntry[] = [
  ...
  },
  {
    ...
    description: '注音符號、英文大小寫、數字，照順序找出來，訓練專注力與視覺搜尋速度！',
    ready: true,
  },
  {
    href: '/games/hanzi',
    emoji: '🈶',
    title: '國字複習',
    titleEn: 'Hanzi Review',
    description: '自己新增學過的國字，聽發音點出正確答案，複習到記熟為止！',
    ready: true,
  },
  {
    ...
    emoji: '🔤',
    title: '單字複習',
    titleEn: 'Word Grid Review',
    description: '大方格聽發音選單字，題目來源可自訂，格子裡有單字、中文、注音、圖示！',
    ready: true,
  },
